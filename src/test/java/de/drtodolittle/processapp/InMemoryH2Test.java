package de.drtodolittle.processapp;
...
public class InMemoryH2Test {
  ...
  private static final String PROCESS_DEFINITION_KEY = "DrToDoLittle";
   ...
   */
  @Test
  @Deployment(resources = "drtodolittle.bpmn")
